...
const ImplementationPricing = ({ pricingData }) => {
    return (
        <div className="bg-gray-50 py-12 light-section">
            <div className="container mx-auto px-6">
                ...
                <div className="text-center mt-12">
                    <p className="text-gray-600 mb-4">{pricingData.additionalInfo.note}</p>
                    <p className="text-sm text-gray-500">{pricingData.additionalInfo.contactText.split('Contact our team')[0]}<span className="text-blue-600 font-semibold cursor-pointer hover:underline">Contact our team</span>{pricingData.additionalInfo.contactText.split('Contact our team')[1]}</p>
                </div>
            </div>
        </div>
    );
...
export default ImplementationPricing; 