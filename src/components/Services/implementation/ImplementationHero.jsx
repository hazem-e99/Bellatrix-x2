...
const ImplementationHero = ({ heroData, onOpenModal }) => {
    return (
                ...
                <div className="w-full max-w-6xl mx-auto px-6">
                    ...
                    <div className="text-center mb-8">
                        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold leading-tight text-white animate-slide-up">
                            ...
                            <span className="inline-block animate-text-glow delay-300">{heroData.titleParts[2]}</span>
                            <br />
                    ...
                    <div className="text-center mb-12">
                        <p className="text-lg md:text-xl lg:text-2xl text-gray-200 leading-relaxed max-w-4xl mx-auto animate-fade-in">
                            {heroData.description.split('digital experiences')[0]}
                            ...
                            {heroData.description.split('digital experiences')[1]}
                        </p>
                    </div>
                        ...
                        >
                            <span className="relative z-10 flex items-center justify-center">
                                <svg className="w-5 h-5 mr-2 transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d={heroData.ctaButton.icon} />
                                </svg>
