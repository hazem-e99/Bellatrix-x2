...
const NetSuiteConsultingProcess = ({ consultingProcess, onStartConsulting }) => {
  return (
    <section className="bg-gray-50 py-20 light-section">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-800 mb-4">
            {consultingProcess.title.split(' ')[0]} <span className="text-blue-600">{consultingProcess.title.split(' ').slice(1).join(' ')}</span>
          </h2>
          <p className="text-lg text-gray-600 leading-relaxed max-w-3xl mx-auto">
            {consultingProcess.description}
          </p>
        </div>
          ...
          <div className="flex-1">
            ...
            <div className="relative">
              ...
              <div className="space-y-6">
                {consultingProcess.process.map((phase, index) => {
...
export default NetSuiteConsultingProcess; 