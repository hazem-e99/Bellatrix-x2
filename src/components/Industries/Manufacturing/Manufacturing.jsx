...
useEffect(() => {
  const fetchData = async () => {
    try {
      ...
      // الطريقة الصحيحة لاستخدام fetch مع ملف JSON
      ...
      // يمكنك هنا إضافة حالة خطأ للعرض في UI
    } finally {
      setLoading(false);
    }
  };
  ...
  useEffect(() => {
    ...
    const challengeInterval = setInterval(() => {
      setActiveChallenge(
        (prev) => (prev + 1) % pageData.challenges.items.length
      );
    }, 4000);
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              {pageData.hero.buttons.map((button, index) => (
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={
                    button.action === "openModal" ? openContactModal : () => {}
                  }
                  className={`${
                  ...
                  <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-700 rounded-xl flex items-center justify-center mb-6">
                    ...
                    >
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth={2}
                        d={pageData.challenges.items[activeChallenge].icon}
                      />
                    </svg>
                  </div>
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-blue-700 font-semibold">
                        Impact:{" "}
                        {pageData.challenges.items[activeChallenge].impact}
                      </span>
                    </div>
                  </div>
                </div>
            ...
            <div className="flex-1">
              <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
                ...
                <div className="space-y-3 mb-6">
                  ...
                  {pageData.solutions.items[activeSolution].features.map(
                    (feature, index) => (
                ...
                <div className="bg-green-900/20 border border-green-400/30 rounded-lg p-4">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-green-300 font-semibold">
                      Result:{" "}
                      {pageData.solutions.items[activeSolution].benefits}
                    </span>
                  </div>
                </div>
              </div>
